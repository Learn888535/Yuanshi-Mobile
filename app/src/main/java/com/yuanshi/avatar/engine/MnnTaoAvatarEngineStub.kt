...
/**
 * 占位实现：MNN TaoAvatar 本地引擎。
 * 当前仅做架构验证，不提供实际渲染。
 */
class MnnTaoAvatarEngineStub(private val context: Context) : DigitalHumanEngine {
    ...
    override fun attach(container: ViewGroup, modelPath: String, callback: DigitalHumanEngine.Callback) {
        ...
        val tv = TextView(context).apply {
            text = "MNN TaoAvatar Engine (stub)"
        ...
        callback.onInitError("MNN TaoAvatar engine not implemented yet")
    }
    ...
    override fun getVersion(): String = "mnn-tao-avatar-stub"

    companion object {
        private const val TAG = "MnnTaoAvatarStub"
    }
}
